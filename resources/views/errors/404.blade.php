...
<body class="authentication-bg authentication-bg-pattern">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-muted mb-0">It's looking like you may have taken a wrong turn. Don't
                                    ...
                                    connection. Here's a little tip that might help you get back on track.</p>
                            </div>
    ...
    <footer class="footer footer-alt">
        2023 - <script>document.write(new Date().getFullYear())</script> &copy; EeasyLearning <a href=""
