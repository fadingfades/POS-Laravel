                        ...
                        <form action="{{ route('employee.attend.store') }}" method="post" id="myForm">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" name="date" id="date"
                                    ...
                                    value="{{ $editData['0']['date'] }}" placeholder="Attendance Date"
                                    autocomplete="off">
                            </div>
